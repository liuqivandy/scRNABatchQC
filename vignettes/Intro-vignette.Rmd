...
# Quick start
To easiest way to generate a summary QC report is to run scRNABatchQC.  The only required input is the vector of file names (or a URL starting http://, file://, etc) for gene-cell count matrices or a vector of path namems from 10X CellRanger >=3.0.
