...
scRNABatchQC returns two objects: one is sces, a list of SingleCellExperiment objects for each individual dataset; the other is scesMerge, a SingleCellExperiment object for the merged dataset. Each SingleCellExperiment object contains raw, normalized and QC metadata, which can be used for downstream analysis.
...
```{r }
# The output contains two objects, sces and scesMerge.  
