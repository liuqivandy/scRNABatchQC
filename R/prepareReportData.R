prepareReportData <- function(inputfiles,samplenames=NULL, organism=c("hsapiens","mmusculus"), sampleRatio=1, cachePrefix,nHVGs=1000,nPC=10,sf=10000,logFC=1,FDR=0.01) {
