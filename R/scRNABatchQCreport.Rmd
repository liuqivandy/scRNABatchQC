...
```{r plotPCA, echo=FALSE, results='asis', fig.align="center", fig.cap=figRef("PC1", "PC2")}
print(plotAllPCA(sceall, scolors))
```

#### TSNE plot

```{r plotTSNE, echo=FALSE, results='asis', fig.align="center", fig.cap=figRef("Dimension 1", "Dimension 2")}
