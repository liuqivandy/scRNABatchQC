...
```{r plotDiffGenes, eval=DISPLAY_FIGURE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align="center", fig.cap=figRef("plotDiffGenes", "Heatmap of differentially expressed genes in pairwise comparison"), fig.height=getHeatmapHeight(plotData$diffFC$genes), fig.width=10}
...
```{r plotDiffPathway, eval=DISPLAY_FIGURE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align="center", fig.cap=figRef("plotDiffPathway", "Heatmap of enriched pathways in differentially expressed genes"), fig.height=getHeatmapHeight(plotData$diffFC$pathways), fig.width=10}
