...
heatmap.2(as.matrix(abs(diffFC$genes)), cexRow = 0.6, margins =heatmapMargins, keysize=heatmapKeysize, col=heatmapPathwayColors)
```
...
heatmap.2(as.matrix(abs(diffFC$pathways)), cexRow = 0.6, margins=heatmapMargins, keysize=heatmapKeysize, col=heatmapPathwayColors)
```
