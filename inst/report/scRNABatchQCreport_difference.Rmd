...
scRNABatchQC detects differentially expressed genes between two experiments (logFC>1 & FDR<0.01, default, we can sepcify logFC, FDR to change the default criteria). 
