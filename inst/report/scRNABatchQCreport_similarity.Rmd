...
```{r plotSamplesimilarity, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align="center", warning=FALSE, fig.cap=figRef("plotSamplesimilarity", "Global expression similarity"), fig.height=4}
