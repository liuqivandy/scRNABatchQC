...
```
`r getHeatmapCaption(hvgPathways,"hvgPath")` shows the -log10 FDR for enriched pathways in HVGs in each experiment and pathway similarity across experiments if there are multiple samples.
...
```
`r getHeatmapCaption(pc1Pathways,"PCgPath")` shows the -log10 FDR for enriched pathways in PC-related genes in each experiment and pathway similarity across experiments if there are multiple samples.
