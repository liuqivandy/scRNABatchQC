...
```{r echo=FALSE, eval=DISPLAY_FIGURE, warning=FALSE, message=FALSE}
if(isHeatmapFigure(hvgBiologicalSimilarity)){
  caption = figRef("hvg")
}else{
  caption = tabRef("hvg")
}
...
```{r plotBiologicalSimilarityHVGenes, eval=DISPLAY_FIGURE & isHeatmapFigure(hvgBiologicalSimilarity), echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align="center", fig.cap=caption, fig.height=getHeatmapHeight(hvgBiologicalSimilarity), fig.width=10}
