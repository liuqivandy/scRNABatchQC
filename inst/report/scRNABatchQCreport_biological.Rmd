...
```{r plotPathwaySimilarityPC1Gene, eval=displayPathway, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='asis', fig.align="center", fig.cap=figRef("plotPathwaySimilarityPC1Gene", "Heatmap of enriched pathways for PC1 genes", trunk.eval=displayPathway), fig.height=getHeatmapHeight(plotData$pc1Pathways), cache=FALSE, fig.width=10}
