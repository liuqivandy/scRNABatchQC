...
print(plotDensity(sces,"pct_counts_rRNA", "The proportion of reads mapped to ribosomal genes", scolors))
...
print(plotVarianceExplained(sces, "genevar_by_counts", scolors))
```
...
print(plotVarianceExplained(sces, "genevar_by_features",scolors))
```
...
print(plotVarianceExplained(sces,  "genevar_by_Mt", scolors))
```
...
print(plotVarianceExplained(sces, "genevar_by_rRNA",scolors))
```
...
plotAllPCA(plotData$scesMerge, scolors)
```
...
plotAlltSNE(plotData$scesMerge, scolors)
```
